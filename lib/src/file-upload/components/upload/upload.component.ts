...
import { FileInputComponent, FileInputLabelDirective } from '../input/input.component';

@Component({
  changeDetection: ChangeDetectionStrategy.OnPush,
  selector: 'psn-file-upload',
...
export class FileUploadComponent {
  ...
  @ContentChild(FileInputLabelDirective) inputLabel: FileInputLabelDirective;
  ...
  /**
   * multiple?: boolean
   * Sets if multiple files can be dropped/selected at once in [FileUploadComponent].
   */
  @Input('multiple')
